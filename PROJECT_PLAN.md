...
> 计划版本：v2.1-catherine-maxed-rework<br>
> 当前状态：Catherine 满级技能、觉醒、测试敌方倍率、UR Blend Shapes、Slime Toon Shader 与黑洞 VFX 已完成；D3D11 Shader、PlayMode、Windows 构建及 1920×1080 / 1280×720 实机视觉验收均通过<br>
> 最近更新：2026-07-14
