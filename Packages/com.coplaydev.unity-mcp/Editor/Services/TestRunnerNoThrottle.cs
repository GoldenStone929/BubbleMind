...
namespace MCPForUnity.Editor.Services
{
    ...
    public static class TestRunnerNoThrottle
    {
        ...
        {
            // Project isolation patch: avoid changing machine-global EditorPrefs during tests.
            if (!string.Equals(
                    Environment.GetEnvironmentVariable("UNITY_MCP_ALLOW_EDITOR_PREF_THROTTLE"),
                    "1",
        ...
        {
            if (!IsGlobalThrottleAllowed()) return;
        ...
        private static bool IsGlobalThrottleAllowed() => string.Equals(
            Environment.GetEnvironmentVariable("UNITY_MCP_ALLOW_EDITOR_PREF_THROTTLE"),
            "1",
