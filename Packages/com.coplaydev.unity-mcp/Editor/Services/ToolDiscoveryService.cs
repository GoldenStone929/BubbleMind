...
namespace MCPForUnity.Editor.Services
{
    public class ToolDiscoveryService : IToolDiscoveryService
    {
        ...
        private readonly Dictionary<string, bool> _sessionOverrides = new();
        ...
        public bool IsToolEnabled(string toolName)
        {
            ...
            if (_sessionOverrides.TryGetValue(toolName, out bool sessionEnabled))
            {
            ...
            {
                var isolatedMetadata = GetToolMetadata(toolName);
                return isolatedMetadata != null &&
                    (isolatedMetadata.AutoRegister || isolatedMetadata.IsBuiltIn);
            }
        ...
        public void SetToolEnabled(string toolName, bool enabled)
        {
            ...
            _sessionOverrides[toolName] = enabled;
            if (!ProjectIsolation.AllowGlobalEditorPrefs) return;
