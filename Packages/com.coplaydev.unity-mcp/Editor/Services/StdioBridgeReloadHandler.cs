...
namespace MCPForUnity.Editor.Services
{
    ...
    {
        private const string ResumeSessionKey = "MCPForUnity.ResumeStdioAfterReload.ProjectIsolated";
        ...
        private static void OnAfterAssemblyReload()
        {
            ...
            try
            {
                bool resumeFlag = SessionState.GetBool(ResumeSessionKey, false);
                bool useHttp = UseHttpTransport();
        ...
        {
            if (string.Equals(
                    Environment.GetEnvironmentVariable("UNITY_MCP_PROJECT_ISOLATED"),
                    "1",
